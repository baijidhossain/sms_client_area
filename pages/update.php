...
<body>
    ...
    <script>
        ...
        async function saveThreadToDB(threads, hasMoreThreads) {
        ...
        // async function loadThreadsFromDB(start_id, limit) {

        //     const threads = (await db.getAllFromIndex("threads", "order_by_lmsg")).reverse();
        //     const targetIndex = threads.findIndex((message) => message.message_id === start_id);
        //     return targetIndex !== -1 ? threads.slice(targetIndex + 1, targetIndex + 1 + limit) : threads.slice(0, limit);
            ...
            try {
                ...
                if (phoneId === 0) {
                    ...
                    fetchData = {
                        ...
                        data: {
                            //items: await loadThreadsFromDB(lastMsgId, 20)
                            items: await getItemsFromDB("threads", "order_by_lmsg", 0)
                        }
                    }
                ...
                // saveThreadToDB(cloneObjFromProxy(newData), hasMore);

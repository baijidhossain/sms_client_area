...
<head>
    ...
    <script>
        ...
        window.ipbxapi_serviceType = 'efax';
    </script>
...
<body>
    ...
    <!-- page components -->
    <script src="<?= APP_URL ?>/public/js/components/efax.js?v=<?= APP_VER ?>"></script>
    ...
    <!-- page functions -->
    <script src="<?= APP_URL ?>/public/js/functions/efax.js?v=<?= APP_VER ?>"></script>
